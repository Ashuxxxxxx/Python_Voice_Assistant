...
**Now Import the below libraries in your python file :- **
...
**
Now setting our engine to Pyttsx3 which is used for text to speech in Python and sapi5 is a Microsoft speech application platform interface we will be using this for text to speech function :- **
